...
　　这张图是有一个**错误点**：应该是每一个 RegionServer 就只有一个 HLog，而不是一个 Region 有一个 HLog。

#### 正确图解

![img](https://images2018.cnblogs.com/blog/1228818/201804/1228818-20180402125236874-140096659.png)
